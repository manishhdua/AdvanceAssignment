...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(home, zoom)); //float number-initialized zoom level
    ...
    private void setMapLongClick(final GoogleMap map){
        map.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            ...
            public void onMapLongClick(LatLng latLng) {
                ...
                map.addMarker(new MarkerOptions().position(latLng).title(getString(R.string.dropped_pin))
                        .snippet(snippet)
    ...
    private void setPoiClick(final GoogleMap map){
        map.setOnPoiClickListener(new GoogleMap.OnPoiClickListener() {
            ...
            public void onPoiClick(PointOfInterest poi) {
                //add a new marker for the POI location, grab the name of POI
